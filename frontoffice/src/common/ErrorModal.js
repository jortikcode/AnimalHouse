const ErrorModal = ({ msg, clearErrorFunction }) => {
  return (
    <div
      ...
      id="my-modal"
    >
      <div className="bg-white p-6 rounded-lg border-4 border-black md:w-96 w-64 max-w-full flex items-center flex-col">
        <p className="font-bold text-red-600 break-words">{msg} </p>
        <button
